...
public class AddTeacherCommand extends FrontCommand {
    private static final Logger LOGGER = LoggerFactory.getLogger(AddTeacherCommand.class.getName());
...
//        checkOnError();
        ...
        return Path.FORWARD_TO_ADD_TEACHER_FORM;
    }
...
//        boolean valid = UserInputValidator.validate();
        ...
        if (true) {
            ...
            LOGGER.trace("The teacher with id {} added." , user.getId() );
        } else {
        ...
        return Path.REDIRECT_TO_ADD_TEACHER_FORM;
